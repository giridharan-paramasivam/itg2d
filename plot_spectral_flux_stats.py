...
plt.axvline(x=k_lin, color='k', linestyle='-.', linewidth=2)
ax = plt.gca()
ax.text(k_Gf, 1.01, r'$k_{G,f}$', transform=ax.get_xaxis_transform(), ha='center', va='bottom', fontsize=xtick_fontsize)
ax.text(k_lin, 1.01, r'$k_{\mathrm{lin}}$', transform=ax.get_xaxis_transform(), ha='center', va='bottom', fontsize=xtick_fontsize)
plt.xscale('log')
plt.xlabel('$k$')
...
plt.axvline(x=k_lin, color='k', linestyle='-.', linewidth=2)
ax = plt.gca()
ax.text(k_Pf, 1.01, r'$k_{P,f}$', transform=ax.get_xaxis_transform(), ha='center', va='bottom', fontsize=xtick_fontsize)
ax.text(k_lin, 1.01, r'$k_{\mathrm{lin}}$', transform=ax.get_xaxis_transform(), ha='center', va='bottom', fontsize=xtick_fontsize)
plt.xscale('log')
plt.xlabel('$k$')
