...
from modules.gamma_PV import gam_max   
...
def rhs_itg(t,y):
    ...
    dPkdt[:]=(-1j*ky*(kapn+kapt)*Phik
              +1j*Gamma*ky*(kapn+kapt)*kpsq*Phik
              +1j*Gamma*ky*kapb*Pk
              -D*kpsq*Pk-sigk*H/(kpsq**2)*Pk)
    ...
    dPkdt[:]+=rft2(dyphi*dxP-dxphi*dyP)+Gamma*nl_term2_num
