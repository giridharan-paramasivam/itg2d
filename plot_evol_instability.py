...
fig.savefig(fname.replace("out_instability_", "phi_amp_vs_t_").replace(".h5", ".svg"), bbox_inches="tight")
plt.show()
plt.close(fig)
...
plt.tight_layout()
os.makedirs(datadir, exist_ok=True)
fig.savefig(fname.replace("out_instability_", "phi_amp_vs_t_fit_").replace(".h5", ".svg"), bbox_inches="tight")
plt.show()
plt.close(fig)
...
plt.tight_layout()
os.makedirs(datadir, exist_ok=True)
fig.savefig(fname.replace("out_instability_", "P_amp_vs_t_").replace(".h5", ".svg"), bbox_inches="tight")
plt.show()
plt.close(fig)
...
plt.tight_layout()
os.makedirs(datadir, exist_ok=True)
fig.savefig(fname.replace("out_instability_", "triad_product_vs_t_").replace(".h5", ".svg"), bbox_inches="tight")
plt.show()
plt.close(fig)
...
plt.tight_layout()
os.makedirs(datadir, exist_ok=True)
fig.savefig(fname.replace("out_instability_", "conserved_quantities_vs_t_").replace(".h5", ".svg"), bbox_inches="tight")
plt.show()
plt.close(fig)
...
plt.tight_layout()
os.makedirs(datadir, exist_ok=True)
fig.savefig(fname.replace("out_instability_", "cos_delta_vs_t_qkp_").replace(".h5", ".svg"), bbox_inches="tight")
plt.show()
plt.close(fig)
# %%