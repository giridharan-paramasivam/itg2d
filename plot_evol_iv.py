...
if rank == 0:
    ...
    if fname.endswith('out.h5'):
        plt.savefig(datadir+'P2_vs_t.svg',dpi=100)
    else:
        plt.savefig(datadir+fname.split('/')[-1].replace('out_', 'P2_vs_t_').replace('.h5', '.svg'),dpi=100)
    plt.show()
    ...
    plt.tight_layout()
    if fname.endswith('out.h5'):
        plt.savefig(datadir+'energy_vs_t.svg',dpi=100)
    else:
        plt.savefig(datadir+fname.split('/')[-1].replace('out_', 'energy_vs_t_').replace('.h5', '.svg'),dpi=100)
    plt.show()
    ...
    plt.tight_layout()
    if fname.endswith('out.h5'):
        plt.savefig(datadir+'zonal_energy_fraction_vs_t.svg',dpi=100)
    else:
        plt.savefig(datadir+fname.split('/')[-1].replace('out_', 'zonal_energy_fraction_vs_t_').replace('.h5', '.svg'),dpi=100)
    plt.show()
    ...
    plt.tight_layout()
    if fname.endswith('out.h5'):
        plt.savefig(datadir+'generalized_energy_vs_t.svg',dpi=100)
    else:
        plt.savefig(datadir+fname.split('/')[-1].replace('out_', 'generalized_energy_vs_t_').replace('.h5', '.svg'),dpi=100)
    plt.show()
    ...
    # else:
    #     plt.savefig(datadir+fname.split('/')[-1].replace('out_', 'entropy_vs_t_').replace('.h5', '.svg'), dpi=100)
    # plt.show()
    ...
    # plt.tight_layout()
    # if fname.endswith('out.h5'):
    #     plt.savefig(datadir+'enstrophy_vs_t.svg',dpi=100)
    # else:
    #     plt.savefig(datadir+fname.split('/')[-1].replace('out_', 'enstrophy_vs_t_').replace('.h5', '.svg'), dpi=100)
    # plt.show()
